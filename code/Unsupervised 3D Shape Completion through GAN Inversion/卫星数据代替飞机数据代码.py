# Unsupervised 3D Shape Completion through GAN Inversion  论文 将飞机数据代替为卫星数据代码
...
for subdirectory in sorted_subdirectories:                # 上级文件夹
    ...
    sampled_incomplete = sampled_incomplete[:3795] #用于适配飞机数据集个数
...
print("完成修改train数据")
# print("值为 0 的索引：", zero_indices)
#
# print(gt[0])
# print(incomplete_pcd[0])
